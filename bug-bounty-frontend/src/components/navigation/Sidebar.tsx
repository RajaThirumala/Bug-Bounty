...
import { LayoutDashboard, ShieldCheck, FileText, Send, User } from "lucide-react";
import { cn } from "@/lib/utils";

const items = [
  { to: "/dashboard", label: "Dashboard", icon: LayoutDashboard },
  { to: "/programs", label: "Programs", icon: ShieldCheck },
  { to: "/reports", label: "Reports", icon: FileText },
  { to: "/submit-report", label: "Submit Report", icon: Send },
